  ...
  <div class="container-fluid">
    ...
    {{--<div class="navbar-left">--}}
      {{--<div class="navbar-btn">--}}
        {{--<a href="{{url('/')}}"><img src="{{asset('image/logo/logo.png')}}" alt="Oculux Logo" class="img-fluid logo"></a>--}}
        ...
        {{--<li class="dropdown">--}}
          ...
          {{--<ul class="dropdown-menu right_chat email vivify fadeIn">--}}
            ...
            {{--<li>--}}
              {{--<a href="javascript:void(0);">--}}
                {{--<div class="media">--}}
                  {{--<img class="media-object " src="{{asset('image/profile/avatar1.jpg')}}" alt="">--}}
                  {{--<div class="media-body">--}}
        ...
        <ul class="nav navbar-nav">
          {{--<li class="dropdown language-menu">--}}
            ...
            {{--<div class="dropdown-menu" aria-labelledby="navbarDropdown">--}}
              {{--<a class="dropdown-item pt-2 pb-2" href="#"><span class="flag-icon flag-icon-gb"></span>&nbsp;&nbsp; English</a>--}}
              {{--<a class="dropdown-item pt-2 pb-2" href="#"><span class="flag-icon flag-icon-at"></span>&nbsp;&nbsp; Austrian</a>--}}
              {{--<a class="dropdown-item pt-2 pb-2" href="#"><span class="flag-icon flag-icon-cn"></span>&nbsp;&nbsp; Chinese</a>--}}
