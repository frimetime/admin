<div class="search_div">
  ...
  <span>@lang('layout.searchResult')<small class="float-right text-muted">@lang('layout.about') 90 results (0.47 seconds)</small></span>
  <div class="table-responsive">
    <table class="table table-hover table-custom spacing5">
      ...
      <tr>
        ...
        <td>
          <div class="d-flex align-items-center">
            <img src="{{asset('image/profile/avatar1.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
            <div class="ml-3">
